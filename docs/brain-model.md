# The brain-development model & original engine (background)

SNC began as a C++ simulator that grows a brain-like network from
biological-development rules — voxel-by-voxel structural plasticity on a
per-neuron leaky-integrate-and-fire chemistry, with sensory organs, multimodal
teaching, and sleep-driven consolidation. The project's **current** focus is the
structure-aware SNN computing substrate (see [`../README.md`](../README.md) and
the [documentation index](README.md)); this document preserves the original
model — the computing engine, the biological model, its primary-source
grounding, and the pack-by-pack history — which is the substrate's origin and
its slow *structural* layer.
...
- **Phase 1' expansion** — multi-voxel pyramidal + interneuron arbours
  ...
  See [docs/figures/07_neuron_morphology.png](figures/07_neuron_morphology.png)
...
![Structural grid](figures/01_structural_grid.png)
...
![One simulation step](figures/02_pipeline.png)
...
![Queue stages](figures/03_queues.png)
...
![Anatomy](figures/04_anatomy.png)
...
![Developmental scaling](figures/05_developmental.png)
...
![Engram allocation](figures/06_engram.png)
...
![Neuron morphology stamps](figures/07_neuron_morphology.png)
...
![Extended neuron shapes](figures/08_extended_neuron_shape.png)
...
**Full plan** through the pre-adolescent goal: see [docs/ROADMAP.md](ROADMAP.md).
